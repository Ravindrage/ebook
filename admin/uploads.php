...
include 'includes/header.php';
		...
		if (isset($_FILES["fileToUpload"]["tmp_name"]) and !empty($_FILES["fileToUpload"]["tmp_name"])) {
			...
			if ($fileExt==".png" || $fileExt==".jpg" || $fileExt==".gif" || $fileExt==".pdf" ) {
		...
		} elseif (isset($_GET["delete"]) AND ($_GET["confirm"]=="yes")) {
   ...
   <div class="row">
	...
	<div class="row">
		...
		<form role="uploadForm" method="post" action="" enctype="multipart/form-data">
			...
			<button type="submit" class="btn btn-default"><i class='fa fa-fw fa-upload'></i> Upload Ebook</button>
		</form>
		</div>
	</div>
	<div class="row">
